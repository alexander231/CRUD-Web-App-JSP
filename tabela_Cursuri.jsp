...
<html>
    ...
    <body style="background:#8499B1;">
        <h1 align="center"> Tabela Curs</h1>
        
        <form action="sterge_Curs.jsp" method="post">
        	<div class="wrapper">
            <table rules = "none" border="1" align="center" style="background:#657F9D;">
                <tr>
                    <td><b>Mark:</b></td>
                    <td><b>Id curs:</b></td>
                ...
                %>
                <tr>
                    <td><input type="checkbox" name="primarykey" value="<%= x%>" id = "tabela_Cursuri"/></td><td><%= x%></td>
            ...
            <p align="center">
            <button type = "button">Sterge curs</button>
